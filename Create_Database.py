...
table2='''Create Table Follow(
    user_id     int,
    follow_id   int,
    Date        Text);'''

table3='''Create Table Questions(
...
table5='''Create Table Media(
    M_id        INTEGER PRIMARY KEY autoincrement,
    A_id        int,
    File_loc    varchar(40));'''

table6='''Create Table Votes(
    V_id        INTEGER PRIMARY KEY autoincrement,
    A_id        int not null,
    user_id     int not null);'''

table7='''Create Table Comments(
